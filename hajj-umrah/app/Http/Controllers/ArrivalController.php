...
class ArrivalController extends Controller 
{
  ...
  public function store(Request $request)
  {
    ...
    $last_inserted_id = TripInfo::create(['info'=>( TripInfo::Select('id')->latest()->first() != null ? TripInfo::Select('id')->latest()->first()->id + 1 : 1 ) .'-'.random_int(1000,9999),'type'=> 'وصول']);
    Arrival::create(['trip_info_id'=>$last_inserted_id->id, 
