          ...
          <div class="row justify-content-md-center">
            ...
            <div class="card" style="height: 838px;">
                <div class="card-header">
                  <h4 class="card-title" id="basic-layout-round-controls">اضافة مغادرة جديدة</h4>
                ...
                <div class="card-content collapse show">
                  <div class="card-body">
                    ...
                    <form class="form" method="POST" action="{{route('departure.store')}}">
                        @csrf
                    <div class="form-body">
                        ...
                        <div class="row">
                          ...
                          <input type="text" id="issueinput2" class="form-control" placeholder="وقت المغادرة" name="departure_time" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Opened By" data-original-title="" title="">
                        </div>
                          </div>
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="issueinput4">تاريخ المغادرة</label>
                              <input type="date" id="issueinput4" class="form-control" name="departure_date" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Date Fixed" data-original-title="" title="">
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" id="issueinput2" class="form-control" placeholder="رقم الرحلة" name="journey_number" data-toggle="tooltip" data-trigger="hover" data-placement="top" data-title="Opened By" data-original-title="" title="">
                        </div>
