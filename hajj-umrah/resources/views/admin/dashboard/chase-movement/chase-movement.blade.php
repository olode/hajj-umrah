...
<head>
  ...
  <title>Advanced DataTable - Robust - Responsive Bootstrap 4 Admin Dashboard Template for
  ...
  <link rel="stylesheet" type="text/css" href="app-assets/css-rtl/core/menu/menu-types/horizontal-top-icon-menu.css">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
