...
<link rel="stylesheet" type="text/css" href="{{asset('dashboard/app-assets/css-rtl/vendors.css')}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('dashboard/app-assets/vendors/css/extensions/unslider.css')}}">
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('dashboard/app-assets/css-rtl/core/menu/menu-types/horizontal-top-icon-menu.css')}}">
  <link rel="stylesheet" type="text/css" href="{{asset('dashboard/app-assets/css-rtl/core/colors/palette-climacon.css')}}">
